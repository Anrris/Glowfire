...
if __name__ == "__main__":
    ...
    test.seed_in_range(mean=(0, 0),  count=10000, diag=(3, 3), offdiag=(1, 1))
    test.seed_in_range(mean=(10, 0), count=10000, diag=(3, 3), offdiag=(1, 2))
    test.seed_in_range(mean=(0, 10), count=10000, diag=(3, 3), offdiag=(2, 1))
    test.seed_in_range(mean=(10, 10),count=10000, diag=(3, 3), offdiag=(1, 2))
    test.seed_in_range(mean=(20, 15),count=10000, diag=(3, 3), offdiag=(1, 2))
    test.seed_in_range(mean=(20, 30),count=10000, diag=(3, 3), offdiag=(1, 2))
    test.seed_in_range(mean=(20, 40),count=10000, diag=(6, 6), offdiag=(3, 2))
    test.seed_in_range(mean=(10, 40),count=10000, diag=(6, 6), offdiag=(3, 2))
    test.seed_in_range(mean=(44, 40),count=10000, diag=(10, 13), offdiag=(3, 2))
